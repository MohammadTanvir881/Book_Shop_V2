    ...
    <div className="container mx-auto px-4 py-8">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Filters Sidebar - Left side on large screens */}
              ...
              <form onSubmit={handleSearchSubmit} className="space-y-6">
                ...
                <div className="flex space-x-3 pt-2">
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition duration-300 text-sm font-medium"
                  >
                    Reset
                  </button>
                  <button
                    type="submit"
                    className="flex-1 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-300 text-sm font-medium"
                  >
                    Apply
                  </button>
                </div>
          ...
          {/* Books Content - Right side on large screens */}
