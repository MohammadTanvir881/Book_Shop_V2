...
const blogs = [
  {
    ...
    description: "Discover how reading books can transform your perspective and creativity.",
    img: "https://images.unsplash.com/photo-1556740749-887f6717d7e4",
    date: "March 10, 2025"
  },
  {
    title: "Best Fiction Books of 2025",
    description: "A curated list of the most captivating fiction books this year.",
  ...
  },
  {
    ...
    description: "How to manage time effectively and read more books in a busy schedule.",
  ...
  },
  {
    ...
    description: "Explore timeless classics that everyone should experience at least once.",
  ...
  },
  {
    ...
    description: "Tips and techniques for writing engaging and insightful book reviews.",
  ...
  },
  {
    ...
    description: "Learn how reading impacts brain development and cognitive skills.",
  ...
  },
  {
    ...
    description: "A selection of self-help books that can guide you toward success and happiness.",
  ...
  },
  {
    ...
    description: "Dive into various book genres and find what suits your taste best.",
  ...
  },
  {
    ...
    description: "Steps to curate and organize your own personal book collection.",
...
<h4 className='text-lg pt-8'>Your one-stop online destination for books of all genres. Whether you're a passionate reader, a student, or looking for the perfect gift, we have something for everyone.</h4>
</h1>
      {blogs.map((blog, index) => (
        ...
        >
          <img src={blog.img} alt={blog.title} className="w-full h-40 sm:h-36 object-cover" />
          <div className="p-4">
            <p className="text-xs text-gray-500">{blog.date}</p>
            <h2 className="text-md font-semibold text-gray-800 mt-1">{blog.title}</h2>
...
<div className="flex justify-center items-center pt-10 pb-10 ">
  <Link to='/'>
  <button className="bg-blue-700 hover:bg-blue-700 text-white font-bold 
