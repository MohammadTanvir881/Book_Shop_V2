      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-50 p-4 rounded">
            <h3 className="font-2xl font-bold dark:text-black  mb-2">
              Shipping Information
            </h3>
            <p className="text-gray-700 ">
              <span className="font-semibold">Customar Name</span>:{' '}
              {order?.user.name}
            </p>
            <p className="text-gray-700">
          ...
          <div className="bg-gray-50 p-4 rounded">
            <h3 className="font-2xl dark:text-black font-bold mb-2">
              Payment Information
            </h3>
            <p className="text-gray-700">
        ...
        <div className="mt-6 ">
          <h3 className="font-medium dark:text-black  mb-3">Products</h3>
          <div className="space-y-4">
            {order?.products?.map((item) => (
              <div
                key={item.product._id}
                className="flex items-center dark:text-black  p-3 border rounded hover:bg-gray-50"
              >
                <img
